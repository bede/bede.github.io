...
- Factual accuracy was always very high
- Most models reasoned their way to a plausible mechanism (likely correct)
- They often made one of two critical analysis errors, repeating claims that saponin-based methods cannot detect extracellular DNA (which no method can in practice due to the abundance paradox) or that RNA viruses cannot be detected citing a study that had no RNA arm.
