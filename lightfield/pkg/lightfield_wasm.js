/* @ts-self-types="./lightfield_wasm.d.ts" */

/**
 * @param {string} sample_name
 * @param {Uint8Array} reads_fastx
 ...
 * @returns {any}
 */
export function run_lightfield(sample_name, reads_fastx, reference_fasta, primer_bed, min_depth, min_ambig_freq, min_ambig_depth, min_var_freq, iupac, kmer_size, normalise_depth) {
    ...
    const ptr2 = passArray8ToWasm0(reference_fasta, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(primer_bed, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.run_lightfield(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, min_depth, min_ambig_freq, min_ambig_depth, min_var_freq, iupac, kmer_size, normalise_depth);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lightfield_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
